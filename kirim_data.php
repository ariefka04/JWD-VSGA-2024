    ...
    $query = mysqli_query($connect, $sql);
        ...
        if($query) {
            echo '<div style="text-align: center;">
                    <h2>Terima Kasih Wir, Pesanan Anda Akan Segera Kami Proses!</h2>
                </div>';
        }
        else {
...
<div class="d-flex justify-content-center">
    <button type="button" class="btn btn-warning me-2" onclick="window.location.href='tabel_pesanan.php'">Lihat Pesanan</button>
    <button type="button" class="btn btn-danger me-2" onclick="window.location.href='pemesanan.php'">Kembali</button>
